 ...
 */
public class IndividualPurchaseReport extends javax.swing.JFrame {

    /**
     * Creates new form IndividualStockReport
     */
    public IndividualPurchaseReport() {
        initComponents();
        initOrderSerial();
    }
    ...
    public void initOrderSerial() {
        ...
        try {
            ...
            PreparedStatement pstm = connection.getConn().prepareStatement("select order_id from order_table where order_type=102");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndividualPurchaseReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IndividualPurchaseReport().setVisible(true);
            }
        });
    }
