 ...
 */
public class WeaklyPurchase extends javax.swing.JFrame {

    /**
     * Creates new form IndividualStockReport
     */
    public WeaklyPurchase() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WeaklyPurchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WeaklyPurchase().setVisible(true);
            }
        });
    }
