 ...
 */
public class YearlyPurchase extends javax.swing.JFrame {
    ...
    void allPurchase(){
        String startYear=Integer.toString(txtYear.getYear())+"-01-01";
        String endYear=Integer.toString(txtYear.getYear())+"-12-31";
        ...
        try {
            connection = new ConnectivitySupport();
              ...
              String query="select i.order_serial, i.order_id, c.client_name, p.product_name, i.quantity, i.total, i.date"
                        ...
                        + " where i.client_id=c.client_id and i.product_id=p.product_id and i.order_id=o.order_id and o.order_type=102 and (i.date between ? and ?)";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Yearly Purchase");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YearlyPurchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new YearlyPurchase().setVisible(true);
            }
        });
    }
